 ...
 *
 */
dualArms2::dualArms2(ros::NodeHandle& rh)
{
    //rh_ = rh;
    ...
    ros::service::waitForService("compute_cartesian_path");
    ros::ServiceClient cart_path_client = rh.serviceClient<moveit_msgs::GetCartesianPath> ("compute_cartesian_path");
 ...
 *
 */
void dualArms2::tf2pose(tf::Transform &tf, geometry_msgs::Pose &pose)
{
 ...
 *
 */
void dualArms2::pose2tf(geometry_msgs::Pose &pose, tf::Transform &tf)
{
 ...
 *
 */
void dualArms2::get_current_right_joint_angles(double current_angles[7])
{
    int i;
...
bool dualArms::call_right_arm_gpik_(void)
{
    ...
    moveit_msgs::GetPositionIK::Request::ik_request::pose_stamped
    req.group_name = "right_arm";
    req.header.frame_id = "/odom_combine";
    req.jump_threshold = 0.001;
